...
parser.add_argument("-r", "--registers", type=int, help="define how mayn registers are avaidable", default=32,
...
args = CompilerArgs(target_lang=parsed.language, mem_size=parsed.memory, stack_size=parsed.stack,
                    memory_blocks=parsed.blocks, register_count=parsed.registers)
